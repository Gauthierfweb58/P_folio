...
<body>
  ...
  <header class="header1" id="accueil">
    ...
    <div class="container-first">
      ...
      <div class="container-btns">
        <a href="#mes_competences"><button class="btn-first b1">Mes compétences</button></a>
    ...
    <img src="ressources/maison_chien.png" class="logo">
 ...
 <section id="section3" class="section bottom-section">
        ...
        <div id="logo2">
          <div class="slider">
            <div class="slide-track">
              ...
              <div class="slide">
                <img src="img/tailwindcss.jpg" height="200" width="250" alt="" />
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="documentation-content">
      ...
      <br>
      <section class="content-section" id="competences">
